...
def generate_referral():
    ...
    if redirect_link and link_name:
        ...
        referral_link = f'http://127.0.0.1:5000/ref?code={unique_code}'  # Change to your deployment URL https://flask-test-53ar.onrender.com  http://127.0.0.1:5000/ www.temkatut.com
